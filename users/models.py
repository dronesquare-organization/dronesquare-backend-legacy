...
class Users(AbstractBaseUser, PermissionsMixin):
    ...
    id = models.BigAutoField(primary_key=True, null=False, blank=False, verbose_name="유저 인덱스")
    email = models.EmailField(unique=True, max_length=200, null=False, blank=False, verbose_name="이메일")
    ...
    plan = models.CharField(default='FREE', max_length=200, null=False, blank=False, verbose_name="플랜")
    phoneNumber = models.CharField(max_length=20, null=False, blank=False, db_column="phone_number", verbose_name="연락처")
    sectors = models.CharField(max_length=200, null=False, blank=False, default="기타", choices=SECTOR_TYPE_CHOICES, db_column="sectors", verbose_name="업종")
    organization = models.CharField(max_length=200, null=False, blank=False, verbose_name="조직 이름")
    planEnrollmentDate = models.DateTimeField(null=False, blank=False, db_column="plan_enrollment_date",
                                              auto_now_add=True, verbose_name='플랜 등록 일자')
...
class Payment(models.Model):
    ...
    account = models.CharField(max_length=355, null=False, blank=False, verbose_name='계좌 번호')
